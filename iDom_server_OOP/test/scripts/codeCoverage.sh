...
echo "tworze html"
llvm-cov-3.9  report ../build-iDom_TESTs-CMAKE-clang-Debug/iDom_TESTs-CMAKE -instr-profile=../build-iDom_TESTs-CMAKE-clang-Debug/test.profdata -use-color > /tmp/coverage.html
