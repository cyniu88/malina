...
const ButtonConfigDef gButtonConfig[] = {
    ...
    {53, MONO_STABLE, KORYTARZ__________117, VIRTUAL_________RELAY, VIRTUAL_________RELAY, "korytarz od salonu"},
    {44, MONO_STABLE, KORYTARZ__________117, VIRTUAL_________RELAY, VIRTUAL_________RELAY, "korytarz od sypialni"},
    {52, MONO_STABLE, LAZIENKA_MALA_____129, VIRTUAL_________RELAY, VIRTUAL_________RELAY, "lazenka mala"},
