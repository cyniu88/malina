...
const ButtonConfigDef gButtonConfig[] = {
    ...
    {37, MONO_STABLE, TARAS_OSWIETLENIE_103, PODBITKA_TARAS____104, VIRTUAL_________RELAY, "z salonu"},
    ...
    {20, MONO_STABLE, WEJSCIE___________106, PODBITKA_WEJSCIE__107, VIRTUAL_________RELAY, "wejscie"},
    ...
    {52, MONO_STABLE, KORYTARZ__________117, VIRTUAL_________RELAY, VIRTUAL_________RELAY, "korytarz od salonu"},
    {44, MONO_STABLE, KORYTARZ__________117, VIRTUAL_________RELAY, VIRTUAL_________RELAY, "korytarz od sypialni"},
    {53, MONO_STABLE, LAZIENKA_MALA_____129, VIRTUAL_________RELAY, VIRTUAL_________RELAY, "lazenka mala"},
    {21, MONO_STABLE, KANCIAPA__________123, WIATROLAP_________130, VIRTUAL_________RELAY, "kanciapa"},
    {49, MONO_STABLE, 125, KORYTARZ__________117, VIRTUAL_________RELAY, "pokoj E"},
    {48, MONO_STABLE, 125, KORYTARZ__________117, VIRTUAL_________RELAY, "pokoj E"},
    {50, MONO_STABLE, 128, VIRTUAL_________RELAY, VIRTUAL_________RELAY, "pokoj N"},
    {51, MONO_STABLE, 128, VIRTUAL_________RELAY, VIRTUAL_________RELAY, "pokoj N"},
    {35, MONO_STABLE, WIATROLAP_________130, WEJSCIE___________106, KANCIAPA__________123, "wiatrolap z salonu"},
    ...
    {17, MONO_STABLE, DZWONEK____________88, WEJSCIE___________106, VIRTUAL_________RELAY, "dzwonek"}};
