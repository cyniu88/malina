...
public:
    RADIO_WEATHER_STATION(thread_context *context, const RADIO_EQ_CONFIG &cfg, RADIO_EQ_TYPE type);
...
public:
    RADIO_BUTTON(thread_context *context, const RADIO_EQ_CONFIG &cfg, RADIO_EQ_TYPE type);
...
public:
    RADIO_SWITCH(thread_context *context, const RADIO_EQ_CONFIG &cfg, RADIO_EQ_TYPE type);
...
public:
    explicit RADIO_EQ_CONTAINER(thread_context *context);
