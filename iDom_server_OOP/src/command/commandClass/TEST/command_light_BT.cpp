...
TEST_F(command_light_Class_fixture, mqtt_bulb_state_update)
{
    ...
    auto ret = test_command_light->execute(test_v,&test_context);
    std::cout << "ret: " << ret << std::endl;
    EXPECT_EQ( test_context.main_house_room_handler->m_lightingBulbMap[226]->getStatus(), STATE::ON);

    test_v.clear();
    test_v.push_back("light");
    test_v.push_back("state;226;30;0\n");
    ret = test_command_light->execute(test_v,&test_context);
    std::cout << "ret: " << ret << std::endl;
    EXPECT_EQ( test_context.main_house_room_handler->m_lightingBulbMap[226]->getStatus(), STATE::OFF);
    test_v.clear();
    test_v.push_back("light");
...
TEST_F(command_light_Class_fixture, mqtt_bulb_state_update_bulb_not_exist)
{
    ...
    auto ret = test_command_light->execute(test_v,&test_context);
    std::cout << "ret: " << ret << std::endl;
    EXPECT_EQ( test_context.main_house_room_handler->m_lightingBulbMap[330]->getStatus(), STATE::ON);
    ...
    ret = test_command_light->execute(test_v,&test_context);
    std::cout << "ret: " << ret << std::endl;
    EXPECT_EQ( test_context.main_house_room_handler->m_lightingBulbMap[330]->getStatus(), STATE::OFF);
    test_v.clear();
    test_v.push_back("light");
    test_v.push_back("info");
    ret = test_command_light->execute(test_v,&test_context);
...
TEST_F(command_light_Class_fixture, on_off_all_bulbs_in_room_command)
{
    EXPECT_EQ(test_context.main_house_room_handler->m_lightingBulbMap.at(226)->getStatus(),
              STATE::UNDEFINE);
    EXPECT_EQ(test_context.main_house_room_handler->m_lightingBulbMap.at(227)->getStatus(),
              STATE::UNDEFINE);
    test_v.clear();
    test_v.push_back("light");
    ...
    EXPECT_EQ(test_context.main_house_room_handler->m_lightingBulbMap.at(126)->getStatus(),
              STATE::ACTIVE);
    EXPECT_EQ(test_context.main_house_room_handler->m_lightingBulbMap.at(127)->getStatus(),
              STATE::ACTIVE);
...
{
    auto ret = test_context.main_house_room_handler->getAllInfoJSON().dump(4);
    ...
    (void)test_command_light->execute(test_v,&test_context);
    ret = test_context.main_house_room_handler->getAllInfoJSON().dump(4);
