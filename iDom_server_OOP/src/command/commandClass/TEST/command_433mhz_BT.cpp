...
TEST_F(command_433MHz_Class_fixture, deleteSwitch)
{
...
TEST_F(command_433MHz_Class_fixture, deleteFakeSwitch)
{
...
TEST_F(command_433MHz_Class_fixture, addButton)
{
...
TEST_F(command_433MHz_Class_fixture, addSwitch)
{
    auto actualSize = test_rec->getSwitchPointerVector().size();
    test_v.push_back("show");
    test_v.push_back("all");
...
TEST_F(command_433MHz_Class_fixture, addExistingWeather)
{
    test_v.push_back("show");
    test_v.push_back("all");
    std::cout << test_command_433MHz->execute(test_v,&test_my_data) << std::endl;
...
TEST_F(command_433MHz_Class_fixture, missingParamiter_addSwitch)
{
    test_v.push_back("show");
    test_v.push_back("all");
    std::cout << test_command_433MHz->execute(test_v,&test_my_data) << std::endl;
...
\
TEST_F(command_433MHz_Class_fixture, add_wrongType_addSwitch)
{
    test_v.push_back("show");
    test_v.push_back("all");
    std::cout << test_command_433MHz->execute(test_v,&test_my_data) << std::endl;
...
TEST_F(command_433MHz_Class_fixture, add_wrongID_addSwitch)
{
    test_v.push_back("show");
    test_v.push_back("all");
    std::cout << test_command_433MHz->execute(test_v,&test_my_data) << std::endl;
