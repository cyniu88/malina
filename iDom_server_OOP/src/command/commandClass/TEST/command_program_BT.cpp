...
public:
    ...
    {
        test_context.iDomProgramState = iDomStateEnum::WORKING;
...
TEST_F(command_program_Class_fixture, unknownParameter)
{
    ...
    auto ret = test_command_program->execute(test_v,&test_context);
...
TEST_F(command_program_Class_fixture, stopProgram)
{
    ...
    test_command_program->execute(test_v,&test_context);
}
